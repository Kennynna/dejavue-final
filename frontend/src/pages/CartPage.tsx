        ...
        <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8">
          ...
          >
            ...
            <h1 className="text-2xl font-light text-foreground sm:text-3xl md:text-4xl">
              Ваша корзина{" "}
              <span className="font-semibold text-primary">пуста</span>
            </h1>
            ...
            <Button
              asChild
              className="mt-6 h-12 w-full sm:mt-8 sm:h-auto sm:w-auto"
              size="lg"
            >
              <Link to="/categories">
                    ...
                    <CardContent className="p-0">
                      <div className="flex gap-3 p-3 sm:gap-4 sm:p-4">
                        ...
                        <div className="hidden flex-col items-end justify-between sm:flex">
                          <span className=" text-primary text-xs font-inter font-bold">
                            {(
                          ...
                          {item.quantity > 1 && (
                            <span className="text-shadow-xs text-muted-foreground text-xs font-inter font-bold">
                              {item.perfume.price.toLocaleString("ru-RU")} ₽ за
                              шт.
                            </span>
                          )}
                        </div>
                      ...
                      {item.quantity > 1 && (
                        <div className=" border-t border-border/50 bg-secondary/20 px-3 py-2 sm:hidden">
                          <p className=" text-muted-foreground text-end text-xs font-inter font-bold"> 
                            {item.perfume.price.toLocaleString("ru-RU")} ×   
                             {item.quantity}
                          </p>
                        </div>
                      )}
              ...
              <Card className="border-border/50 lg:sticky lg:top-24">
                <CardContent className="p-4 sm:p-6">
                  <div className="mt-4 space-y-3 sm:mt-6 sm:space-y-4">
                    <div className="border-t border-border pt-3 sm:pt-4">
                      <div className="flex items-center justify-between gap-3">
                        <div className="flex-1">
                          ...
                          <p className="mt-0.5 text-[16px] text-muted-foreground sm:mt-1 sm:text-sm">
                           <span className="text-xs font-inter font-bold">+ 300</span> <span className="text-xs font-inter font-bold">₽</span> по Грозному
                          </p>
                        </div>
                        <Switch
                          id="delivery"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className=" text-primary sm:text-2xl text-xs font-inter font-bold">
                  ...
                  <p className="mt-3 text-center text-[14px] text-muted-foreground sm:mt-4">
                    Хотите уточнить или спросить по поводу товара? Ответим на
                    любые вопросы
                  </p>
