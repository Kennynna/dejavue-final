    ...
    <div className="flex h-full flex-col space-y-5 sm:space-y-6">
      {isMobile && (
        <div className="flex items-center justify-between border-b border-border pb-4">
          ...
          <Button variant="ghost" size="icon" onClick={onClose} className="h-10 w-10 touch-target">
            <X className="h-5 w-5" />
          </Button>
        </div>
      )}
      ...
      {hasFilters && (
        <Button variant="ghost" size="sm" onClick={clearAll} className="h-10 text-muted-foreground">
